...
function CustomerReferrerRatio({title,subtitle, keyNumber, perctChange}) {
  const chartData = {
    labels: [
      "12-01-2021",
      "01-01-2022",
    ...
    datasets: [
      // Indigo line
      {
        data: [0.16, 0.29, 0.31, 0.45, 0.18, 0.65, 0.34, 0.49, 0.58, 0.34, 0.54, 0.6],
        fill: true,
...
export default CustomerReferrerRatio;