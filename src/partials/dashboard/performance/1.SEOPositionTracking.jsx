...
function SEOPositionTracking() {
  ...
  return (
    <div className="col-span-full sm:col-span-12 bg-white shadow-lg rounded-sm border border-slate-200">
      ...
      <h2 className="ml-5 mt-2 text-slate-500">Customers find you with these keywords!</h2>
      <div className="p-3 flex-col ">
        <LineChart className={""} data={chartData} width={595} height={248} format={false} title="51.1K" perctChange="-2.01%" />
        {/* Table */}
